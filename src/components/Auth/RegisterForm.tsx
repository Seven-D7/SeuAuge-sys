  ...
  return (
    <div className="w-full max-w-md space-y-4 sm:space-y-6">
      <div className="text-center">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Junte-se ao Meu Auge</h2>
        <p className="text-slate-400 text-sm sm:text-base">Comece sua transformação de bem-estar hoje</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-slate-800 border border-slate-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm sm:text-base"
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            readOnly
            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-slate-700 border border-slate-600 rounded-lg text-white text-sm sm:text-base"
          />
        </div>

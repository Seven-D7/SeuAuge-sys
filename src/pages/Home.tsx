...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      {/* Header */}
      <header className="bg-white/70 backdrop-blur-xl shadow-lg border-b border-white/20 sticky top-0 z-50 before:absolute before:inset-0 before:bg-gradient-to-r before:from-emerald-50/30 before:to-white/50 before:backdrop-blur-xl before:-z-10">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="bg-gradient-to-br from-primary via-emerald-500 to-emerald-600 text-white p-2 sm:p-2.5 rounded-2xl shadow-xl shadow-emerald-500/25 ring-1 ring-white/20 backdrop-blur-sm">
                <img
              ...
              <div>
                <h1 className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-800 via-gray-700 to-primary bg-clip-text text-transparent">
                  Meu Auge
                </h1>
                <p className="text-xs sm:text-sm text-gray-600/80 hidden sm:block font-medium">Transforme Sua Vida</p>
              </div>
            </div>
            <div className="hidden md:flex items-center gap-6 lg:gap-8">
              <a href="#planos" className="text-gray-700/90 hover:text-primary transition-all duration-300 font-medium text-sm lg:text-base relative group">
                Planos
              ...
              <a href="#sobre" className="text-gray-700/90 hover:text-primary transition-all duration-300 font-medium text-sm lg:text-base relative group">
                Sobre
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary rounded-full transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#depoimentos" className="text-gray-700/90 hover:text-primary transition-all duration-300 font-medium text-sm lg:text-base relative group">
                Depoimentos
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary rounded-full transition-all duration-300 group-hover:w-full"></span>
              </a>
              <Button
                onClick={handleStartJourney}
                className="bg-gradient-to-r from-primary to-emerald-600 hover:from-primary-dark hover:to-emerald-700 text-white shadow-lg hover:shadow-xl hover:shadow-emerald-500/25 transition-all duration-300 text-sm lg:text-base px-6 py-2.5 rounded-xl font-semibold ring-1 ring-white/20 backdrop-blur-sm transform hover:scale-105"
              >
                Começar Agora
              </Button>
            </div>
            ...
            <div className="md:hidden">
              <Button
                onClick={handleStartJourney}
                size="sm"
                className="bg-gradient-to-r from-primary to-emerald-600 hover:from-primary-dark hover:to-emerald-700 text-white text-xs sm:text-sm px-4 py-2 rounded-xl font-semibold shadow-lg ring-1 ring-white/20 backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
              >
                Entrar
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <Card className="text-center p-6 sm:p-8 border-0 bg-white/80 backdrop-blur-md border border-emerald-200 hover:bg-white/90 transition-all duration-300 transform hover:scale-105 shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">Nutrição Inteligente</h3>
              <p className="text-gray-600">
            ...
            <Card className="text-center p-6 sm:p-8 border-0 bg-white/80 backdrop-blur-md border border-emerald-200 hover:bg-white/90 transition-all duration-300 transform hover:scale-105 shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">Comunidade Ativa</h3>
              <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <Card className="p-6 sm:p-8 border-0 bg-white/80 backdrop-blur-md border border-emerald-200 hover:bg-white/90 transition-all duration-300 shadow-sm">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h4 className="font-bold text-lg text-gray-800">João Santos</h4>
